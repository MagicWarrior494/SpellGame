...
namespace Vulkan
{
	...
	inline uint32_t findMemoryTypeImage(VkPhysicalDevice physicalDevice, uint32_t typeFilter, VkMemoryPropertyFlags properties) {
		...
		VulkanImage& outImage)
	{
		...
		allocInfo.memoryTypeIndex = findMemoryTypeImage(vulkanCore->physicalDeviceData.vkPhysicalDevice, memRequirements.memoryTypeBits, properties);
