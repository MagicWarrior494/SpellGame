...
namespace Vulkan
{
    ...
    inline VkPipelineLayout CreatePipelineLayout(VulkanCore* VC, const PipelineLayoutInfo& info)
    {
    ...
    inline VkPipeline CreateGraphicsPipeline(VulkanCore* VC, const PipelineInfo& info)
    {
        // 1. Load shaders
